# Project Readme
## Title: 
Correlation between tweets with the word donald trump and the price of the amaerican dollar
...
To run the file you need to use python and install tweepy,set the twitter credentials in a file named twitter_credentials.py

## Introductions: 
we set the principal libraries to get the  twitter data and we did a test with the words Donald Trump
